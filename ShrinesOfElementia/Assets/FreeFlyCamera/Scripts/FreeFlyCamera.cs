...
public class FreeFlyCamera : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (_enableMovement)
        {
            ...
            Debug.Log(-Input.GetAxis("Look Y") * _mouseSense);

            if (Input.GetKey(KeyCode.W))
                deltaPosition += transform.forward;

            deltaPosition += transform.right * Input.GetAxis("Horizontal");
            deltaPosition += transform.forward * Input.GetAxis("Vertical");
        ...
        if (_enableRotation)
        {
            ...
            transform.rotation *= Quaternion.AngleAxis(
                Input.GetAxis("Look Y") * _mouseSense,
                Vector3.right
            );
            ...
            transform.rotation = Quaternion.Euler(
                ...
                transform.eulerAngles.y + Input.GetAxis("Look X") * _mouseSense,
