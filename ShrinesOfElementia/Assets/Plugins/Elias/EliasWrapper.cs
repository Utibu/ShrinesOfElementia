...
public class EliasWrapper
{
    ...
    private static extern elias_result_codes elias_start_background(elias_handle handle, IntPtr start_event);
    public static elias_result_codes elias_start_background_wrapped(elias_handle handle, elias_event_set_level start_event)
    {
        IntPtr start_event_ptr = IntPtr.Zero;
        start_event_ptr = Marshal.AllocHGlobal(Marshal.SizeOf(@start_event.GetType()));
        Marshal.StructureToPtr(start_event, start_event_ptr, true);
        elias_result_codes returnValue = elias_start_background(handle, start_event_ptr);
        Marshal.FreeHGlobal(start_event_ptr);
        return returnValue;
    }
    ...
    public static extern elias_result_codes elias_start_background_with_action_preset(elias_handle handle, string preset_name);
