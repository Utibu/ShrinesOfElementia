      ...
      #endif
      {
         ...
         o.Normal = half3(0, 0, 1);
            ...
            o.Alpha = l.Alpha;
               ...
               o.Albedo = DiffuseAndSpecularFromMetallic(l.Albedo, l.Metallic, o.Specular);
            #else
...
ENDCG
   ...
   Dependency "BaseMapGenShader" = "/Example_Base885629024"
   Dependency "BaseMapShader" = "/Example_Base885629024"
